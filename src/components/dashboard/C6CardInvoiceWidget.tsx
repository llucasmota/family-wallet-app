  ...
  return (
    <Card variant="elevated" className="flex flex-col gap-4 p-5 border border-outline-variant/30 bg-surface-container/60 dark:bg-[#151A18] relative overflow-hidden">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <div className="flex items-center gap-2">
              <h3 className="font-bold text-sm text-on-surface">{tC6('title')}</h3>
        ...
        >
          {tCommon('appName')} <ArrowUpRight className="h-3.5 w-3.5" />
        </Link>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 pt-1">
        <div className="rounded-m3-md bg-surface p-3 border border-outline-variant/20 dark:bg-[#121614]">
          <span className="text-[11px] text-on-surface-variant block">{tC6('totalInvoice')}</span>
        ...
        <div className="rounded-m3-md bg-surface p-3 border border-outline-variant/20 dark:bg-[#121614]">
          <span className="text-[11px] text-amber-500 font-semibold flex items-center gap-1">
            <Clock className="h-3.5 w-3.5" /> {tCommon('pending')}
          </span>
        ...
        <div className="rounded-m3-md bg-surface p-3 border border-outline-variant/20 dark:bg-[#121614]">
          <span className="text-[11px] text-emerald-600 dark:text-emerald-400 font-semibold flex items-center gap-1">
            <CheckCircle2 className="h-3.5 w-3.5" /> {tCommon('paid')}
          </span>
          <span className="text-lg font-bold text-on-surface">
      ...
      {/* Breakdown by Member (Responsabilidade da fatura C6) */}
